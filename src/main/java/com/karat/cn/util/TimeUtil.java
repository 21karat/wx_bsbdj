...
public class TimeUtil {
    ...
    public static Date string2Timeyyyymmdd(String dateString) throws java.text.ParseException {
    ...
    public static String string2stringyyyymmdd(String dateString) throws java.text.ParseException {
        DateFormat dateFormat;
        dateFormat = new SimpleDateFormat("yyyy-MM-dd", Locale.CHINA);
        dateFormat.setLenient(false);
        Date timeDate = dateFormat.parse(dateString);
...
//		cal.set(Calendar.DAY_OF_WEEK, 2);
    ...
    public static String getRemainingTime(String time) throws ParseException {
        ...
        Long date = TimeUtil.systemtimeLong();
        long dd = mm - date;
        String str = "";
        if (dd > 0) {
            dd = dd / 1000;
     ...
     * @return
     */
    public static String getCurrentTimeBeforTime() {
        int ms=(int)(1+Math.random()*(60-1+1));
        SimpleDateFormat fd = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Calendar calendar = Calendar.getInstance();//此时打印它获取的是系统当前时间
        calendar.add(Calendar.SECOND, -ms);//当前系统时间 的  前10 秒的时间
    ...
    public static void main(String[] args){
        ...
        System.out.println(getCurrentTimeBeforTime());
    }
